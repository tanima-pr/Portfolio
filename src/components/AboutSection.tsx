...
const ABOUT_TEXT =
  "I'm a Data Analyst with 2+ years of experience building SQL/Python-driven reporting pipelines, Power BI/Tableau dashboards, and KPI frameworks across healthcare, finance, and operational datasets. With a Master of Engineering from the University of Ottawa, I focus on turning raw numbers into clear, actionable insights.";
      ...
      <div className="relative z-10 flex flex-col items-center gap-10 sm:gap-14 md:gap-16 text-center">
        <FadeIn delay={0} y={40}>
          ...
          <div className="flex flex-col items-center gap-12 sm:gap-16 md:gap-20">
                    <AnimatedText
                      text={ABOUT_TEXT}
                      className="font-medium leading-relaxed text-[#D7E2EA] max-w-2xl text-center"
                    ...
                    <FadeIn delay={0.15} className="w-full max-w-3xl">
                      <div className="flex flex-col gap-5 sm:gap-6">
                        {[
                          ...
                          {
                            label: 'Databases',
                            items: ['MySQL', 'PostgreSQL', 'BigQuery'],
                          },
                          {
                            label: 'BI & Analytics',
                            items: ['Power BI', 'Tableau', 'Excel', 'Pandas', 'NumPy'],
                          },
                          {
                            label: 'Tools & Platforms',
                            items: ['Git', 'Jira', 'Postman', 'REST APIs'],
                          },
                        ].map((group) => (
                          <div
                            key={group.label}
